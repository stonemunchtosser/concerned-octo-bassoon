...
export default function AboutUs() {
  ...
  const [showFakePagePopup, setShowFakePagePopup] = useState(null);

  useEffect(() => {
    const checkScreenSize = () => {
      setIsSmallScreen(window.innerWidth < 1186 || window.innerHeight < 679);
    };
  ...
  const openFakePage = (page) => {
    if (isSmallScreen && showPopup) {
      // If we're in a popup on small screen, show fake page as another popup
      setShowFakePagePopup(page);
    } else {
      // Normal behavior for large screens or when not in popup
      setFakePage(page);
    }
  };

  const closeFakePage = () => {
    if (showFakePagePopup) {
      setShowFakePagePopup(null);
    } else {
      setFakePage(null);
    ...
    <div className="aboutpage-app">
          ...
          {!fakePage && (
            <div className="aboutpage-collapsible-sections">
              <div className="aboutpage-collapsible" onClick={() => toggleSection("story")}>
                <h2>+ FRC Team</h2>
                {!isSmallScreen && openSection === "story" && (
                  <p>
              ...
              <div className="aboutpage-collapsible" onClick={() => toggleSection("mission")}>
                <h2>+ FLL Team</h2>
                {!isSmallScreen && openSection === "mission" && (
                  <p>
      ...
      {showPopup && (
        <>
          ...
          <div className="about-popup">
            <button className="about-popup-close" onClick={closePopup}>×</button>
              ...
              {showPopup === "story" && (
                <>
                  ...
                  <p>
                    ...
                    <span
                      style={{ color: "#00ff66", textDecoration: "none", cursor: "pointer" }}
                      onClick={() => { closePopup(); openFakePage("chargedup"); }}
                    >
                      here
                    </span>
                    .
                    ...
                    <span
                      style={{ color: "#00ff66", textDecoration: "none", cursor: "pointer" }}
                      onClick={() => { closePopup(); openFakePage("crescendo"); }}
                    >
                      here
                    </span>
                    .
                    ...
                    <span
                      style={{ color: "#00ff66", textDecoration: "none", cursor: "pointer" }}
                      onClick={() => { closePopup(); openFakePage("reefscape"); }}
                    >
                      here
                    </span>
                    .
      ...
      {showFakePagePopup && (
        <>
          ...
          <div className="about-popup fake-page-popup">
            <button className="about-popup-close" onClick={closeFakePage}>×</button>
            <div className="about-popup-content">
              {showFakePagePopup === "chargedup" && (
                <>
                  <h2>Charged Up (2023)</h2>
                  <p>
                    Our debut season in the FRC was Charged UP. The game featured two pieces - a inflatable purple cube and a yellow cone - which teams
                    had to place in specific scoring zones. During the endgame, alliances aimed to balance as many of their robots as possible on their scale.
                    If you're interested about the specifics of the game, please check out the official animation{" "}
              ...
              {showFakePagePopup === "reefscape" && (
                <>
                  <h2>Reefscape (2025)</h2>
                  <p>
                    This year was our team's third season competing in FRC,
                    and we were thrilled to attend the Canadian Pacific Regional, now held at the Pacific Coliseum in Vancouver, BC!
                    <br />
